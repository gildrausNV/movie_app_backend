...
//                        .requestMatchers(HttpMethod.GET, "/movies**").hasAnyAuthority(Role.USER.getAuthority())
//                        .requestMatchers(HttpMethod.GET, "/actors**").hasAnyAuthority(Role.USER.getAuthority())
